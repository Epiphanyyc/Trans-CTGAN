...
class TransformerGenerator(Module):
    ...
    def __init__(self, embedding_dim, generator_dim, data_dim, num_layers=4, num_heads=8, hidden_dim=256):
        ...
        self.transformer_encoder = TransformerEncoder(
            TransformerEncoderLayer(d_model=hidden_dim, nhead=num_heads, dim_feedforward=hidden_dim, batch_first=True,norm_first=True,dropout=0.1),
...
class TransformerDiscriminator(Module):
    ...
    def __init__(self, input_dim, discriminator_dim, num_layers=4, num_heads=8, hidden_dim=256, pac=10):
        ...
        self.transformer_encoder = TransformerEncoder(
            TransformerEncoderLayer(d_model=hidden_dim, nhead=num_heads, dim_feedforward=hidden_dim, batch_first=True),
            num_layers=num_layers
        )
